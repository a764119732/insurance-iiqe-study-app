...
- 普通 A/B/C/D 题：第 3 段只能解释**非正确选项**为什么错。
...
- 组合题例外：如果题目包含 i/ii/iii/iv，第 3 段标题仍必须保持固定标题，但段内先解释每个小项对错，再解释 A/B/C/D 组合；不得把正确选项的完整理由搬到第 3 段。
- 必须逐项解释未选选项。
...
17. 普通题第 3 段解释了正确选项，或出现 "A 对" / "B 对" / "C 对" / "D 对"；组合题除外，但必须先解释 i/ii/iii/iv 小项，再解释 A/B/C/D 组合。
18. 出现内部审计备注，如"新增题待复核"、"待人工复核"、"先确认答案"、"教材依据待确认"、"rewrite_basis"、"risk_note"、"audit"、"spotcheck"。

## Golden Sample Driven Rewrite

后续大范围返修必须先判断题型，再选择最接近的黄金样本。不要只照标题套格式；必须以黄金样本校准解释质量。

黄金样本文件：`GOLDEN_EXPLANATION_SAMPLES.md`。
...
1. 类似 P1-553 的题，必须说明题目方向是"毋须披露/例外"，第 2 段解释为什么正确答案属于例外，第 3 段解释其他选项为什么通常必须披露。
2. 类似 P1-244 / P1-245 的题，必须识别为正向定义题；合约相对性题要说明合约通常只约束签约当事人，不能误判为反向题。
3. 类似 P1-279 的组合题，必须按"先 i/ii/iii/iv 小项，后 A/B/C/D 组合"处理，并讲清代理/委托责任方向。
4. 类似 P1-1291 的反向绝对化题，必须说明"机会较小"不等于"完全没有风险"；第 2 段集中解释正确答案为什么错，第 3 段只解释其他非答案选项为什么不选。
