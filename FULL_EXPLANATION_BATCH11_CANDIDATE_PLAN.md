# Full Explanation Batch 11 Candidate Plan

Updated: 2026-06-01

Objective: select 60 low-risk ordinary template explanations for beginner-friendly rewrite.

Selection rules applied:
- Excluded Full Explanation Batch 1-10 IDs.
- Excluded `P1-018`, `P1-091`, `P3-131`.
- Excluded IDs in `RISKY_DO_NOT_AUTO_REGISTRY.md`.
- Excluded obvious legal-boundary, answer-conflict, option-conflict, and PDF/OCR-uncertain items.
- Preferred P1 Chapter 4 operational-function questions with usable `original_explanation`.
...
Decision: all 60 candidates proceed to manual audit.
