...
7. **一级标题必须精确匹配**以下 4 个标题，不得改写、加入破折号或省略文字：
   ...
   - `3. 逐项解释其他选项为什么错`
   - `4. 记忆口诀`
8. **第 3 段标题必须固定**为 `3. 逐项解释其他选项为什么错`，禁止 `3. ——解释其他选项为什么错`、`3. 一一解释其他选项为什么错`、`3. 其他选项为什么不适合`、`3. 其他选项为什么错`、`3. 逐项解释` 等写法。
